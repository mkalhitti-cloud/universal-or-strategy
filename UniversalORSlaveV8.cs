...
namespace NinjaTrader.NinjaScript.Strategies
{
    ...
    /// </summary>
    public class UniversalORSlaveV8 : Strategy
    {
        #region Variables
        ...
        protected override void OnStateChange()
        {
            ...
            else if (State == State.DataLoaded)
            {
                ...
                Print($"SLAVE V8 | {slaveId} | Tick: {tickSize} | PV: ${pointValue}");
                Print($"SLAVE V8 | Risk: ${RiskPerTrade} | Contracts: {MinContracts}-{MaxContracts}");
                Print($"SLAVE V8.1 | Stop Sync: {UseMasterStopSync} | Trail Settings: {UseMasterTrailSettings}");
            }
            ...
            else if (State == State.Terminated)
            {
                ...
                Print($"SLAVE V8 | {slaveId} | TERMINATED");
            }
        }
