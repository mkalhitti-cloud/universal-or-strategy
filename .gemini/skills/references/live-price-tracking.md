...
## Should I Check for Disconnects?
Yes. Check time gaps between ticks.
...
protected override void OnMarketData(MarketDataEventArgs e)
{
    ...
    // If you see gaps > 2 seconds, Rithmic may have disconnected
...
5. [ ] Trailing stop should update between bar closes
