...
namespace NinjaTrader.NinjaScript.Strategies
{
    ...
    /// </summary>
    public class UniversalORSlaveV8_15 : Strategy
    {
        #region Variables
        ...
        private void ManageTrailingStops()
        {
            try
            {
                ...
                foreach (var kvp in activePositions)
                {
                    ...
                    bool isSingleContract = (pos.TotalContracts == 1);
                    
                    if (profitPoints >= pos.Trail3Trigger && (pos.CurrentTrailLevel < 4) && (isSingleContract || (pos.T1Filled && pos.T2Filled)))
                    {
                    ...
                    else if (profitPoints >= pos.Trail2Trigger && (pos.CurrentTrailLevel < 3) && (isSingleContract || pos.T1Filled))
                    {
                        // Trail 2
                        newStopPrice = pos.Direction == MarketPosition.Long
        ...
        private void SubmitBracketOrders(SlavePosition pos)
        {
            try
            {
                ...
                // Submit T1 - Skip if 1 contract (V8.15 Runner Logic)
