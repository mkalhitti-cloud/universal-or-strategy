---
name: docs-manager
description: Lightweight Haiku sub-agent for documentation updates. Handles CHANGELOG.md entries, milestone summaries, and README updates. Auto-triggers on documentation requests.
---
...
**Report**: "✓ CHANGELOG.md updated with V8_2_BUGFIX entry"
