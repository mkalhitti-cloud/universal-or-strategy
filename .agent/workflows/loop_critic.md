...
Use this workflow after any ENGINEER (P5) implementation to validate correctness before Director handoff.
...
2. ENGINEER runs mandatory self-audit BEFORE submitting for critique:
   - `dotnet test Testing.csproj` -- must be 0 failures (GATE: cannot submit without this)
...
5. **Was `dotnet test` skipped?** Flag as protocol violation and add to Phase 1 gate.
